function media() {
    ...
    let n2 = Number(window.prompt(`Além de ${n1}, qual foi a outra nota de 
   ${nom}?`))
    med = (n1 + n2)/2
   ...
   style='color:red;'>${msg}</strong></p>` // Note que eu usei até um pouco de CSS pra fazer a mensagem ficar vermelha ;)
   }